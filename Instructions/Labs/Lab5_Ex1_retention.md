...
1. Sie sollten weiterhin bei Client 1 VM (SC-401-CL1) als **SC-401-CL1\admin** angemeldet und in Microsoft Purview als Joni Sherman angemeldet sein.

1. Klicken Sie auf das App-Startfeld (das Rastersymbol) in der oberen linken Ecke aus und wählen Sie anschließend im Untermenü **SharePoint** aus.

   ![Der Screenshot zeigt, wo die Auslassungspunkte sind, um das Aktionsmenü anzuzeigen.](../Media/sharepoint-app-launcher.png)
